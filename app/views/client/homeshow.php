...
<body>
    ...
    <div class="main-wrapper">
            ...
            <div class="haeader-mid-area bg-gren border-bm-1 d-none d-lg-block ">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="search-box-wrapper" style="padding-left: 70px;">
        ...
        <div class="main-content-wrap shop-page section-ptb">
            <div class="container">
                <h2 class="fs-6 my-3 text-secondary">Kết quả tìm kiếm đối với sản phẩm có tên bao gồm kí tự: <?= $keywords ?></h2>
                <div class="row">
