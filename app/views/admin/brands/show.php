                    ...
                    <div class="bg-white my-3 rounded">
                        <div class="d-flex justify-content-between align-items-center p-2">
                            ...
                            <form class="d-flex align-items-center" method="POST" action="<?= BASE_URL . '/brands-show' ?>" autocomplete="off">
                                <div class="col-auto">
                                    <input type="text" class="form-control" placeholder="Tên thương hiệu theo name" name="tim-kiem-thuong-hieu" id="tim-kiem-thuong-hieu">
                                </div>
                                <div class="col-auto">
                                    <button type="submit" class="btn btn-success ms-2">Tìm kiếm</button>
                                </div>
                            </form>
                            <a href="<?= BASE_URL . '/brands-create' ?> " class="btn btn-primary mb-2 px-3">Thêm Thương Hiệu
                            </a>
                        </div>
                        <h2 class="fs-6 my-3 text-secondary ps-2">Kết quả tìm kiếm đối với thương hiệu có tên thương hiệu bao gồm kí tự: <?= $keywords ?></h2>
                        <div class="p-2">
                            <table class="table">
