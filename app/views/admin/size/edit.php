...
<head>
    ...
    <title>Thay Đổi Kích Thước</title>
</head>
        ...
        <div class="box-content">
            <div class="boxmpr row gap-2 ">
                ...
                <div class="box-product col bg-secondary rounded bg-opacity-10">
                    ...
                    <tbody>
                            <td> -->
                    <h4 class="text-center p-3 ">Sửa Kích Thước</h4>
                    <form action="<?= BASE_URL . '/size-update' ?>" method="post">
                        <label for="" class="fw-bolder ">Size: </label>
                        <input type="text" name="id" value="<?= $size->id ?>" hidden required>
                        <input type="text" name="name" value="<?= $size->name ?>" class="p-1 me-2" required>
