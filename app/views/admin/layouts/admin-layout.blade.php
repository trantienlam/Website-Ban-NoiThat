...
<body>
    <div class="container">
        ...
        <section class="d-flex justify-content-between align-items-center border-bottom">
            <!-- logo -->
            <div class="py-2">
                <a href="{{ BASE_URL . '/dashboard' }}" class="text-black text-decoration-none">
            ...
            <div class="col-3">
                <nav>
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><a class="text-black text-decoration-none" href="{{ BASE_URL . '/product-image-index' }}">Quản lí ảnh nhỏ</a></li>
