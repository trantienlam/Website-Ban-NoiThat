        ...
        <div class="box-content">
            <div class="boxmpr row gap-2 ">
                ...
                <div class="box-product col bg-secondary rounded bg-opacity-10">
                    ...
                    <h4 class="text-center p-3 ">Thêm Ảnh</h4>
                    <form action="<?= BASE_URL . '/product-image-store' ?>" method="post" enctype="multipart/form-data" class="text-center">
                        ...
                        <input class="mb-3" type="file" name="link" required>
                        <br>
