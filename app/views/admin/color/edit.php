        ...
        <div class="box-content">
            <div class="boxmpr row gap-2 ">
                ...
                <div class="box-product col bg-secondary rounded bg-opacity-10">
                    ...
                    <tbody>
                            <td> -->
                    <h4 class="text-center p-3 ">Sửa Màu Sắc</h4>
                    <form action="<?= BASE_URL . '/color-update' ?>" method="post">
                        <label for="" class="fw-bolder ">Màu: </label>
                        <input type="text" name="id" value="<?= $color->id ?>" hidden required>
                        <input type="text" name="name" value="<?= $color->name ?>" class="p-1 me-2" required>
