                ...
                <div class="box-product col bg-secondary rounded bg-opacity-10">
                    <div class="bg-white my-3 rounded">
                        <div class="d-flex justify-content-between align-items-center p-2 frm-search">
                            ...
                            <form method="POST" action="<?= BASE_URL . '/color-show' ?>" autocomplete="off" class="input-group w-50 ">
                                <input class="form-control border-end-0 border rounded-pill" type="search" placeholder="Nhập màu sắc" name="tim-kiem-color" id="tim-kiem-color" required>
            ...
            $('#tim-kiem-color').keyup(function() {
                ...
                if (keywords != '') {
                    ...
                    $.ajax({
                        ...
                        url: "<?= BASE_URL . '/search-color-index' ?>",
                        // phương thức gửi
                        method: "POST",
                        ...
                        success: function(result) {
                            ...
                            $('.li-ajax').click(function() {
                                // console.log(1);
                                $("#tim-kiem-color").val($(this).text());
                                // con tror khi nối sẽ xuất hiện 
                                $("#tim-kiem-color").focus();
                                $('#search-ajax').fadeOut();
                            })
                            // console.log(result);
                        }
