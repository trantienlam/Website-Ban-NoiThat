    ...
    <div class="container">
        <header class="m-3">
            <div class="header-main d-flex justify-content-around align-items-center">
                <div class="head-logo">
                    <a href="<?= BASE_URL . '/color-index' ?>" class="text-decoration-none text-black fw-bold fs-4"><iconify-icon icon="ic:baseline-watch"></iconify-icon> <span class="">F-Watch</span></a>
                </div>
                ...
                <div class="box-product col bg-secondary rounded bg-opacity-10">
                    <div class="bg-white my-3 rounded">
                        <div class="d-flex justify-content-between align-items-center p-2">
                            <h5 class="fw-bold">List Color</h5>
                            <div class="input-group w-50">
                                <input class="form-control border-end-0 border rounded-pill" type="search" placeholder="Search" name="tim-kiem-color" id="tim-kiem-color" required>
                        ...
                        <h2 class="fs-6 my-3 text-secondary p-2">Kết quả tìm kiếm đối với: <?= $keywords ?></h2>
                        <div class="p-2">
                            <table class="table">
