                    ...
                    <div class="bg-white my-3 rounded">
                        <div class="d-flex justify-content-between align-items-center p-2">
                            ...
                            <form class="d-flex align-items-center" method="POST" action="<?= BASE_URL . '/banner-show' ?>" autocomplete="off">
                                <div class="col-auto">
                                    <input type="text" class="form-control" placeholder="Tim-banner theo id" name="banner" id="banner">
                                </div>
                                <div class="col-auto">
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex p-3 mt-5">
                                                ...
                                                <form action="<?= BASE_URL . '/banner-destroy' ?>">
                                                    ...
                                                    <button class="btn btn-primary bg-danger border-light" onclick="return confirm('Bạn có chắc chắn muốn xóa banner không')"><iconify-icon icon="material-symbols:delete-rounded"></iconify-icon></button>
                                                </form>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
