        ...
        <div class="box-content">
            <div class="boxmpr row gap-2 ">
                ...
                <div class="box-product col bg-secondary rounded bg-opacity-10">
                    <h3 class="text-center p-3">Sửa Banner </h3>
                    <form action="<?= BASE_URL . '/banner-update' ?>" method="post" enctype="multipart/form-data" class="text-center">
                        <input name="id" type="number" value="<?= $productBanner->id ?>" hidden>
                        <img class="mb-3 me-3" id="blah" src=" <?= './public/uploads/banner/' . $productBanner->image ?>" width="100" height="100" />
