...
<div class="container">
    <form class="mb-3" action="<?php echo e(BASE_URL . '/pay-method'); ?>" method="POST">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <p class="text-danger"><?php echo e($amount . ' VNĐ'); ?></p>
            <input type="text" class="form-control" value="<?php echo e($amount); ?>" hidden name="total_price">
        </div>
        <div>
...
<?php echo $__env->make('client.layouts.client-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\da1\app\views/client/pay.blade.php ENDPATH**/ ?>